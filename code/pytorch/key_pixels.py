...
class KeyPixelFinder():
    ...
    def get_using_grad_near_average(self, original_PIL_image, predicted_class=None, original_tensor=None):
        ...
        return self._quiet_pixels_to_key_pixels(quiet_pixels, original_PIL_image, lambda x: light_dark_filter(0.25, x) )
    
    def _quiet_pixels_to_key_pixels(self, quiet_pixels, original_PIL_image, filter_=None):
        """
